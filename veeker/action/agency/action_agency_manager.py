...
from element.element_agency_manager import ElementManager
from action.basepage import BasePage
from common import output


class AgencyManager(BasePage, ElementManager):
    u"""
    分销商操作员管理
    """
...
if __name__ =='__main__':
    ...
    b = AgencyManager()
    error = b.add_manager(manager_account ="41000000027")
    b.del_manager(manager_account ="41000000027")
    print error['msg']