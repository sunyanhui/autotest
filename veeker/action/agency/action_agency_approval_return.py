...
from element.element_agency_approval_return import ElementApprovalReturn
from action.basepage import BasePage
from common import output
from selenium.webdriver.common.by import By

class AgencyApprovalReturn(BasePage, ElementApprovalReturn):
    u'''
    分销商审批客户退货
    '''
...
if __name__ == '__main__':
    ...
    a.login('41000000002', '888888')

    b = AgencyApprovalReturn()
    print b.approval('103569147244000024')
