...
from element.element_supermarket_customer_order_query import ElementCustomerOrderQuery
from action.basepage import BasePage
from common import output


class SupermarketCustomerOrderQuery(BasePage, ElementCustomerOrderQuery):
    u'''
    超市客户订单查询
    '''
