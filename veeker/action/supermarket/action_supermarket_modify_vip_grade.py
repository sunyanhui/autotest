...
from element.element_supermarket_modify_vip_grade import ElementModifyVipGrade
from action.basepage import BasePage
from common import output


class SupermarketModifyVipGrade(BasePage, ElementModifyVipGrade):
    u'''
    修改超市会员等级
    '''
