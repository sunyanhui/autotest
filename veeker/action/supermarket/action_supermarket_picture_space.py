...
import time
from element.element_supermarket_picture_space import ElementPictureSpace
...
class SupermarketPictureSpace(BasePage, ElementPictureSpace):
    u'''
    超市图片空间
    '''
