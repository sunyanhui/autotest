...
import time
from element.element_supermarket_recruit import ElementRecruit
...
class SupermarketRecruit(BasePage, ElementRecruit):
    u'''
    超市招聘信息
    '''
...
if __name__ =='__main__':
    ...
    b = SupermarketRecruit()
    #error = b.add_recruit()

    for i in range(5):
        b.del_recruit(u"美工设计")
    #print error.msg
    # print error.msg