...
import time
from element.element_supermarket_release_group import ElementReleaseGroup
from action.basepage import BasePage
from common import output

class SupermarketReleaseGroup(BasePage, ElementReleaseGroup):
    u'''
    企业发布团购商品
    '''
