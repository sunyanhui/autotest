...
from element.element_enterprise_introduction import ElementIntroduction
from action.basepage import BasePage
from common import output


class EnterpriseIntroduction(BasePage, ElementIntroduction):
    u'''
    修改超市基本信息页面对象
    '''
    ...
    def modify_structure(self, structure, **kwargs):
        u'''
        修改超市组织结构
        '''
