...
import time
from element.element_enterprise_goods_in_storage import ElementGoodsInStorage
from action.basepage import BasePage
from common import output

class EnterpriseGoodsInStorage(BasePage, ElementGoodsInStorage):
    u'''
    企业发布商品
    '''
...
if __name__ =='__main__':
    ...
    b = EnterpriseGoodsInStorage()
    error = b.delete("copxbynkz")
    print error.msg