...
test_shop_basic_information_case1 = Model(
...
test_shop_basic_information_case2 = Model(
    username=Account.shop,
    password='888888',
...
# testcase3 验证手机号输入为空
test_shop_basic_information_case3 = Model(
    username=Account.shop,
    password='888888',
    telephone='',
...
# testcase4 验证手机号输入汉字
test_shop_basic_information_case4 = Model(
    username=Account.shop,
    password='888888',
    telephone=u'我是好人',
    error_information=u'手机号格式不正确')
...
# testcase5 验证手机号输入英文
test_shop_basic_information_case5 = Model(
    username=Account.shop,
    password='888888',
    telephone='abcdefg',
    error_information=u'手机号格式不正确')
...
test_shop_basic_information_case6 = Model(
    username=Account.shop,
    password='888888',
    weixin='!@$#$',
...
# testcase7 验证微信号输入空格
test_shop_basic_information_case7 = Model(
    username=Account.shop,
    password='888888',
    weixin=' ',
    error_information=u'微信号格式为 5-20个字母、数字、下划线或减号！')
...
# testcase8 验证微信号输入汉字
test_shop_basic_information_case8 = Model(
    username=Account.shop,
    password='888888',
    weixin=u'我是好人',
    error_information=u'微信号格式为 5-20个字母、数字、下划线或减号！')
...
test_shop_basic_information_case9 = Model(
    username=Account.shop,
    password='888888',
    weixin='abc_123',)

# testcase10 验证微信号输入汉字
test_shop_basic_information_case10 = Model(
    username=Account.shop,
    password='888888',
    weixin='1234',
    error_information=u'微信号格式为 5-20个字母、数字、下划线或减号！')
...
test_shop_basic_information_case11 = Model(
    username=Account.shop,
    password='888888',
...
test_shop_basic_information_case12 = Model(
    username=Account.shop,
    password='888888',
    weixin='123456',)

# testcase13 验证微信号输入为空
test_shop_basic_information_case13 = Model(
    username=Account.shop,
    password='888888',
    weixin='',)

# testcase14 验证微信号输入html字符
test_shop_basic_information_case14 = Model(
    username=Account.shop,
    password='888888',
    weixin='</input>',
    error_information=u'微信号格式为 5-20个字母、数字、下划线或减号！')
...
test_shop_basic_information_case15 = Model(
    username=Account.shop,
    password='888888',
...
test_shop_basic_information_case18 = Model(
    username=Account.shop,
    password='888888',
...
test_shop_basic_information_case19 = Model(
    username=Account.shop,
    password='888888',
    location='',
...
test_shop_basic_information_case20 = Model(
    username=Account.shop,
    password='888888',
...
test_shop_basic_information_case21 = Model(
    username=Account.shop,
    password='888888',
...
test_shop_basic_information_case22 = Model(
    username=Account.shop,
    password='888888',
    agency_account='~!@#$%^',
    error_information=u'对公账号只能是16-19位数字')
...
test_shop_basic_information_case23 = Model(
    username=Account.shop,
    password='888888',
    agency_account='',
    error_information=u'请填写信息！')
...
test_shop_basic_information_case24 = Model(
    username=Account.shop,
    password='888888',
    agency_account='11 111  111',
    error_information=u'对公账号只能是16-19位数字')

# testcase25 验证对公账号输入框输入小于16个数字
test_shop_basic_information_case25 = Model(
    username=Account.shop,
    password='888888',)