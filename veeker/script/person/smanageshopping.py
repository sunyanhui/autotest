    ...
    def apply_return(self, **w):
        ...
        try:
            ...
            for i in range(int(orderpage[1])):
                for j in driver.find_elements(*deleteorder):
                    if pattern2.search(j.get_attribute('href')):
                        j.parent.find_element(*applyreturn).click()
        ...
        return {'result': True, 'describtion': 'apply goods success'}
...
if __name__ == '__main__':
    ...
    testcase = dict(ordernumber='101735043637000237',returnreason='01', returndescription='1234567890', returnnumber='1')
