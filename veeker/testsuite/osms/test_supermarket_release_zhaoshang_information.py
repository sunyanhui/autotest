...
if config.ENV == 'test':
    from testdata_test.osms.data_supermarket_release_zhaoshang_information import *
else:
    from testdata_online.osms.data_supermarket_release_zhaoshang_information import *
