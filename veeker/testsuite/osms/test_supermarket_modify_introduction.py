...
class TestSupermarketModifyIntroduction(unittest.TestCase):
    ...
    def setUp(self):
        self.login = Login()
        self.supermarket_modify_introduction = SupermarketIntroduction()
    ...
    def test_modify_introduction_case1(self):
        ...
        r = self.supermarket_modify_introduction.modify_introduction(**test_modify_introduction_case1)
        self.assertTrue(r['result'], r['msg'])
    ...
    def test_modify_introduction_case2(self):
        ...
        self.assertTrue(r['result'], r['msg'])
        r = self.supermarket_modify_introduction.modify_culture(**test_modify_introduction_case2)
        self.assertTrue(r['result'], r['msg'])
    ...
    def test_modify_introduction_case3(self):
        ...
        self.assertTrue(r['result'], r['msg'])
        r = self.supermarket_modify_introduction.modify_structure(**test_modify_introduction_case3)
        self.assertTrue(r['result'], r['msg'])
