...
if config.ENV == 'test':
    from testdata_test.olsm.data_agency_basic_information import *
else:
    from testdata_online.olsm.data_agency_basic_information import *

from action.action_login import Login
from action.agency.action_agency_basic_information import AgencyBasicInformation
import unittest
import time

class TestAgencyBasicInformation(unittest.TestCase):
    u'''
    测试联盟店商品品牌
    '''
    def setUp(self):
        self.login_page = Login()
        self.basic_information_page = AgencyBasicInformation()
    ...
    def test_basic_information_case1(self):
        ...
        case = test_agency_basic_information_case1
    ...
    def test_basic_information_case2(self):
        ...
        case = test_agency_basic_information_case2
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case3(self):
        ...
        case = test_agency_basic_information_case3
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case4(self):
        ...
        case = test_agency_basic_information_case4
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case5(self):
        ...
        case = test_agency_basic_information_case5
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case6(self):
        ...
        case = test_agency_basic_information_case6
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case7(self):
        ...
        case = test_agency_basic_information_case7
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case8(self):
        ...
        case = test_agency_basic_information_case8
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case9(self):
        ...
        case = test_agency_basic_information_case9
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case10(self):
        ...
        case = test_agency_basic_information_case10
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case11(self):
        ...
        case = test_agency_basic_information_case11
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case12(self):
        ...
        case = test_agency_basic_information_case12
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case13(self):
        ...
        case = test_agency_basic_information_case13
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case14(self):
        ...
        case = test_agency_basic_information_case14
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case15(self):
        ...
        case = test_agency_basic_information_case15
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case16(self):
        ...
        case = test_agency_basic_information_case16
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case17(self):
        ...
        case = test_agency_basic_information_case17
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case18(self):
        ...
        case = test_agency_basic_information_case18
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case19(self):
        ...
        case = test_agency_basic_information_case19
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case20(self):
        ...
        case = test_agency_basic_information_case20
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case21(self):
        ...
        case = test_agency_basic_information_case21
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case22(self):
        ...
        case = test_agency_basic_information_case22
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case23(self):
        ...
        case = test_agency_basic_information_case23
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case24(self):
        ...
        case = test_agency_basic_information_case24
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
    ...
    def test_basic_information_case25(self):
        ...
        case = test_agency_basic_information_case25
        self.assertTrue(self.login_page.open_browser(config.OSMS_URL),u"打开首页失败")
